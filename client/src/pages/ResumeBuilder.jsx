import { ArrowLeftIcon, User, FileTextIcon, Form, Briefcase, GraduationCap, Folder, Sparkles, ChevronLeft, ChevronRight, Utensils, ShareIcon, EyeIcon, EyeOffIcon, Download } from 'lucide-react';
...
const ResumeBuilder=()=>{
    ...
    const changeResumeDataVisibility=async()=>{
        try{
                    ...
                    <div className='lg:col-span-7 max-lg:mt-6'>
                        {/* <div className='relative w-full'>
                            <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                                ...
                                <button onClick={changeResumeDataVisibility} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-lg ring-blue-300 hover:ring transition-colors'>
                                    {resumeData.public ? <EyeIcon className='size-4'/> : <EyeOffIcon className='size-4'/>}
                                    {resumeData.public ? 'Public' : 'Private'}
                                </button>

                                <button onClick={viewResume}
                                    className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-lg ring-blue-300 hover:ring transition-colors'> View
                                </button>
