...
const Testimonial=()=>{
    ...
    return(
        ...
        <div id='testimonials' className='flex flex-col items-center my-10 scroll--mt-12'>
            ...
            <Title title="Dont just take our words" description="Hear what our users say about us. We are always looking for ways to improve. If you have a positive experince with us, leave a review." />
        </div>
